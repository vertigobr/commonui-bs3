...
$(document).ready(function () {
    $.ajax({url: "https://collectory.ala-dev.vertigo.com.br/collectory/ws/institution/count"})
        .done(function (data) {
...
$(document).ready(function () {
    $.ajax({url: "https://collectory.ala-dev.vertigo.com.br/collectory/ws/collection/count"})
        .done(function (data) {
...
$(document).ready(function () {
    $.ajax({url: "https://collectory.ala-dev.vertigo.com.br/collectory/ws/dataResource/count"})
        .done(function (data) {
...
$(document).ready(function () {
    $.ajax({url: "https://biocache-service.ala-dev.vertigo.com.br/biocache-service/occurrences"})
        .done(function (data) {
